/**
 * Copyright (c) 2001-2013, David A. Clunie DBA Pixelmed Publishing. All rights
 * reserved.
 */
...
/**
 * <p>
 * A class that extends {@link java.io.FilterOutputStream FilterOutputStream} by
 * adding the concept of little and big endian binary value encoding, and
 * supplies functions for writing various sized integer and floating point
 * words.</p>
 *
...
public class BinaryOutputStream extends FilterOutputStream
{
    ...
    /**
     * <p>
     * Get the byte offset where the next byte will be written.</p>
     *
     * <p>
     * Will be zero at the start of the file.</p>
     *
     ...
     * <code>OutputStream</code> supplied in the constructor, and overrides the
     * default use of multiple calls to the single-byte write method that is the
     * behavior of <code>FilterOutputStream</code>.
     * <p>
     * The exceptions thrown are whatever is thrown by the
     * <code>OutputStream</code> write method.
     *
     * @param b the data.
...
//System.err.println("BinaryOutputStream.write(): len = "+len);
    ...
    /**
     * <p>
     * Write one unsigned integer 8 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write one unsigned integer 16 bit value.</p>
     *
     * @param	v	an int containing an unsigned value
     * @exception	IOException
     */
    ...
    /**
     * <p>
     * Write one signed integer 16 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write one unsigned integer 32 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write one signed integer 32 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write one floating point 32 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write one floating point 64 bit value.</p>
     *
    ...
    /**
     * <p>
     * Write an array of unsigned integer 16 bit values.</p>
     *
...
//System.err.println("BinaryOutputStream.writeUnsigned16(): len = "+len);
    ...
    /**
     * <p>
     * Write an array of floating point 32 bit values.</p>
     *
    ...
    /**
     * <p>
     * Write an array of floating point 64 bit values.</p>
     *
     * @param	f	an array of floats to write
     * @param	len	the number of values to write
     * @exception	IOException
     ...
     * @param	n
     */
    /*private void dumpBuffer(String msg, int n)
     {
