...
namespace MysteriesRL.Game
{
    ...
    {
        public const string MRL_NAME = "MysteriesRL";
        public const string MRL_VER = "v0.5.0.0";
        public const string MRL_DEV_TIME = "2015";
        public const string MRL_COPYRIGHT = "Copyright (c) " + MRL_DEV_TIME + " by Serg V. Zhdanovskih";
        ...
        static MRLData()
        {
            ...
            AddTile(new TileRec(156, (char)15, Colors.White, Colors.Black, true, new TileFlags(TileFlags.tfForeground), 1000.0f)); // tid_Streetlight
